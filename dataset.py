...
class EurDataset(Dataset):
    def __init__(self, split='train'):
        data_dir = ''#LLL change the data address at 2022-01-14 4:10pm origin:/import/antennas/Datasets/hx301/
        with open(data_dir + 'data/europarl/{}_data.pkl'.format(split), 'rb') as f:
